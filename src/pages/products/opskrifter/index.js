...
export default function Opskrift(props) {
  ...
  return (
    <>
      <Head>
        <title>{props.page.page.metaFields.sideTitel}</title>
        <meta name="description" content={props.page.page.metaFields.sideBeskrivelse}></meta>
      ...
      <div className="md:grid md:grid-cols-6 md:gap-4 mb-32 mt-4 p-4 2xl:p-0 md:mt-16">
        ...
        <aside className=" md:col-span-2 md:pr-10">
          ...
          <div className="">
            <nav>
              ...
              <ul className={"grid grid-rows-flow gap-2 bg-white p-10 mb-1 transition-all overflow-scroll " + (genderFilter ? "max-h-[250px] pt-4 pb-10" : "max-h-0 overflow-hidden py-0")}>
                  {
          ...
          <div className="">
            <nav>
              ...
              <ul className={"grid grid-rows-flow gap-2 bg-white p-10 mb-1 transition-all overflow-scroll " + (itemFilter ? "max-h-[250px] pt-4 pb-10" : "max-h-0 overflow-hidden py-0")}>
                  {
          ...
          <div className="">
            <nav>
              ...
              <ul className={"grid grid-rows-flow gap-2 bg-white p-10 mb-1 transition-all overflow-scroll " + (difficultyFilter ? "max-h-[250px] pt-4 pb-10" : "max-h-0 overflow-hidden py-0")}>
                  {
        ...
        <div className="col-span-4">
          <div className="pb-16 hidden md:grid grid-cols-4 gap-4">
            <h1 className="font-serif text-5xl mb-4 col-span-3">{page.title}</h1>
            <p className="text-black-60 col-span-3">{page.metaFields.sideBeskrivelse}</p>
            <div className="col-span-4">
              <Button href={"/learn/forstaaopskrifter"}>Forstå strikkeopskrifter</Button>
            </div>
          </div>
